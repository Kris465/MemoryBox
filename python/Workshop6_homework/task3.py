    ...
    while sweets > 0:
        if current_turn == True:
            ...
            if user_action > sweets:
                ...
                print("Congratulations!" if yes_mes == 'yes' else "Thank you, so I won!")
            sweets -= user_action
            current_turn = False
        else:
            ...
            if 1 < k and k < step:
                ...
                my_action = [sweets - 2 if k == 0 else sweets - 1]
            else: my_action = step
        ...
        if sweets > 0:
            ...
            print(*["I have won!" if current_turn == True else "You have won!"])
