...
if is_non_decreasing(number):
    print(f"Цифры числа {number} при просмотре справа налево упорядочены по неубыванию.")
else:
    print(f"Цифры числа {number} при просмотре справа налево не упорядочены по неубыванию.")
