...
perimeter_second = trapezoid_perimeter(base1_second, base2_second, height_second)
...
print(f"Площадь первой трапеции: {area_first:.2f}, периметр первой трапеции: {perimeter_first:.2f}")
print(f"Площадь второй трапеции: {area_second:.2f}, периметр второй трапеции: {perimeter_second:.2f}")
print(f"Сумма площадей: {sum_areas:.2f}, сумма периметров: {sum_perimeters:.2f}")
