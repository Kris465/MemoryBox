# Массив с температурами за каждый день июля (примерные данные)
temperatures = [
    25, 27, 30, 29, 31, 28, 26,
    32, 33, 31, 30, 29, 28, 27,
    34, 35, 33, 32, 31, 30, 29,
    28, 27, 26, 25, 24, 23, 22,
    # Можно добавить реальные данные
]
...
# Перебираем все возможные семидневные окна
...
# Получаем семидневный интервал с самыми теплыми днями
warmest_week = temperatures[start_index_of_max_window:
    start_index_of_max_window+7]
