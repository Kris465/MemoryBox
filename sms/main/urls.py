...
urlpatterns = [
    ...
    path('admin/students/', StudentManagementView.as_view(), name='manage_students'),
    path('admin/students/add/', StudentCreateView.as_view(), name='add_student'),
    path('admin/students/<int:id>/update/', StudentUpdateView.as_view(), name='update_student'),
    path('admin/students/<int:id>/delete/', StudentDeleteView.as_view(), name='delete_student'),
    ...
    path('teacher/grades/<int:course_id>/', GradeBookView.as_view(), name='teacher_gradebook'),
    path('teacher/grades/add/', AddGradeView.as_view(), name='add_grade'),
    path('teacher/attendance/<int:schedule_id>/', AttendanceView.as_view(), name='attendance'),
    ...
    path('student/settings/', StudentSettingsView.as_view(), name='student_settings'),
]
